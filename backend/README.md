...
## Project Structure
    ...
    ├── calendar_template_38069  # Django project configurations
...
1. Clone this repo and `cd calendar_template_38069`
...
2. Clone this repo and `cd calendar_template_38069`
